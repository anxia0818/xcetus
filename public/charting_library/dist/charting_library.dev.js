...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).TradingView = {});
}(void 0, function (t) {
  "use strict";

  function e(t, n) {
    var i = _objectSpread({}, t);

    for (var _o in n) {
      "object" != _typeof(t[_o]) || null === t[_o] || Array.isArray(t[_o]) ? void 0 !== n[_o] && (i[_o] = n[_o]) : i[_o] = e(t[_o], n[_o]);
    }
  ...
  function () {
    function r(t) {
      ...
      var i, s;
      if (this._id = "tradingview_".concat((1048576 * (1 + Math.random()) | 0).toString(16).substring(1)), this._ready = !1, this._readyHandlers = [], this._onWindowResize = this._autoResizeChart.bind(this), !t.datafeed) throw new Error("Datafeed is not defined");
      (null === (i = t.overrides) || void 0 === i ? void 0 : i["mainSeriesProperties.priceAxisProperties.lockScale"]) && (console.warn("mainSeriesProperties.priceAxisProperties.lockScale can not be set to true within the widget constructor"), delete t.overrides["mainSeriesProperties.priceAxisProperties.lockScale"]), this._options = e(n, t);
      "dark" === (null !== (s = this._options.theme) && void 0 !== s ? s : "light").toLowerCase() && void 0 === this._options.loading_screen && (this._options.loading_screen = {
        backgroundColor: "#131722"
      }), this._options.debug && (o || (o = !0, console.log("Using CL v26.004 (internal id ef42da82 @ 2023-11-17T06:25:31.999Z)"))), this._create();
    }
    ...
    _createClass(r, [{
      ...
      value: function _autoResizeChart() {
        ...
        this._options.fullscreen && (this._iFrame.style.height = window.innerHeight + "px", a && setTimeout(function () {
  ...
  var a = !("undefined" == typeof window || !window.navigator || !window.navigator.userAgent) && window.navigator.userAgent.includes("CriOS");
  t.version = s, t.widget = r, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});