...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[8385, 8115, 306], {
  59255: function _(t, e, n) {
    n.r(e), n.d(e, {
    ...
    function v(t) {
      ...
      if ("border-box" === r.boxSizing && (Math.round(a + i) !== e && (a -= p(r, "left", "right") + i), Math.round(c + s) !== n && (c -= p(r, "top", "bottom") + s)), !function (t) {
    ...
    var g = function () {
      ...
      var n,
          ...
          a,
          c,
          u = (r = (n = e).x, o = n.y, i = n.width, s = n.height, a = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, c = Object.create(a.prototype), l(c, {
        x: r,
        y: o,
        width: i,
        height: s,
    ...
    var I = void 0 !== i.ResizeObserver ? i.ResizeObserver : O;
  },
  20037: function _(t, e, n) {
    function r() {
    ...
    n.d(e, {
      FixedSizeList: function FixedSizeList() {
        return I;
      },
      VariableSizeList: function VariableSizeList() {
        return O;
      }
    });
    ...
    var u = function u(t, e) {
      ...
      return function () {
        ...
        return i && n === this && e(s, o) || (r = t.apply(this, s), i = !0, n = this, o = s), r;
      };
    };

    var l = n(50959),
        f = "object" == (typeof performance === "undefined" ? "undefined" : _typeof(performance)) && "function" == typeof performance.now ? function () {
    ...
    function v(t) {
      if (void 0 === t && (t = !1), null === p || t) {
        ...
        var r = document.createElement("div"),
            o = r.style;
        return o.width = "100px", o.height = "100px", e.appendChild(r), document.body.appendChild(e), e.scrollLeft > 0 ? p = "positive-descending" : (e.scrollLeft = 1, p = 0 === e.scrollLeft ? "negative" : "positive-ascending"), document.body.removeChild(e), p;
      }
    ...
    function _(t) {
      ...
      return n = e = function (t) {
        function e(e) {
          var n;
          return (n = t.call(this, e) || this)._instanceProps = g(n.props, s(s(n))), n._outerRef = void 0, n._resetIsScrollingTimeoutId = null, n.state = {
            instance: s(s(n)),
            isScrolling: !1,
            scrollDirection: "forward",
            scrollOffset: "number" == typeof n.props.initialScrollOffset ? n.props.initialScrollOffset : 0,
            scrollUpdateWasRequested: !1
          }, n._callOnItemsRendered = void 0, n._callOnItemsRendered = u(function (t, e, r, o) {
          ...
          }), n._callOnScroll = void 0, n._callOnScroll = u(function (t, e, r) {
            ...
            if (u.hasOwnProperty(t)) e = u[t];else {
            ...
            return e;
          }, n._getItemStyleCache = void 0, n._getItemStyleCache = u(function (t, e, n) {
            return {};
            ...
            n.setState(function (t) {
              ...
              return s = Math.max(0, Math.min(s, i - r)), {
                isScrolling: !0,
            ...
            n._outerRef = t, "function" == typeof e ? e(t) : null != e && "object" == _typeof(e) && e.hasOwnProperty("current") && (e.current = t);
        ...
        i(e, t), e.getDerivedStateFromProps = function (t, e) {
        ...
        return n.scrollTo = function (t) {
          ...
          t = Math.max(0, Math.min(t, n - 1)), this.scrollTo(f(this.props, t, e, r, this._instanceProps));
          ...
          if (f > 0) for (var z = E; z <= x; z++) {
            R.push((0, l.createElement)(e, {
              data: h,
              key: p(z, h),
              index: z,
          ...
          return (0, l.createElement)(_ || y || "div", {
            className: n,
            onScroll: I,
      ...
      }(l.PureComponent), e.defaultProps = {
        direction: "ltr",
        itemData: void 0,
        layout: "vertical",
        overscanCount: 2,
    ...
    var y = function y(t, e) {
      ...
      return s + (n - i - 1) * o;
        ...
        O = _({
      getItemOffset: function getItemOffset(t, e, n) {
        return g(t, e, n).offset;
      },
      getItemSize: function getItemSize(t, e, n) {
        return n.itemMetadataMap[e].size;
      },
      getEstimatedTotalSize: w,
      getOffsetForIndexAndAlignment: function getOffsetForIndexAndAlignment(t, e, n, r, o) {
        var i = t.direction,
            s = t.height,
            a = t.layout,
            c = t.width,
      ...
      getStartIndexForOffset: function getStartIndexForOffset(t, e, n) {
        return function (t, e, n) {
          var r = e.itemMetadataMap,
              o = e.lastMeasuredIndex;
          return (o > 0 ? r[o].offset : 0) >= n ? b(t, e, o, 0, n) : S(t, e, Math.max(0, o), n);
        }(t, n, e);
      },
      getStopIndexForStartIndex: function getStopIndexForStartIndex(t, e, n, r) {
        for (var o = t.direction, i = t.height, s = t.itemCount, a = t.layout, c = t.width, u = "horizontal" === o || "horizontal" === a ? c : i, l = g(t, e, r), f = n + u, h = l.offset + l.size, d = e; d < s - 1 && h < f;) {
          d++, h += g(t, d, r).size;
        }

        return d;
      },
      initInstanceProps: function initInstanceProps(t, e) {
        var n = {
          itemMetadataMap: {},
          estimatedItemSize: t.estimatedItemSize || 50,
          lastMeasuredIndex: -1
        };
        return e.resetAfterIndex = function (t, r) {
          void 0 === r && (r = !0), n.lastMeasuredIndex = Math.min(n.lastMeasuredIndex, t - 1), e._getItemStyleCache(-1), r && e.forceUpdate();
        }, n;
      },
      shouldResetStyleCacheOnItemSizeChange: !1,
      validateProps: function validateProps(t) {
        t.itemSize;
      }
    }),
        I = _({
      getItemOffset: function getItemOffset(t, e) {
        return e * t.itemSize;
      },
      getItemSize: function getItemSize(t, e) {
        return t.itemSize;
      },
      getEstimatedTotalSize: function getEstimatedTotalSize(t) {
        var e = t.itemCount;
        return t.itemSize * e;
      },
      getOffsetForIndexAndAlignment: function getOffsetForIndexAndAlignment(t, e, n, r) {
        var o = t.direction,
            i = t.height,
            s = t.itemCount,
            a = t.itemSize,
      ...
      getStartIndexForOffset: function getStartIndexForOffset(t, e) {
        var n = t.itemCount,
            r = t.itemSize;
        return Math.max(0, Math.min(n - 1, Math.floor(e / r)));
      },
      getStopIndexForStartIndex: function getStopIndexForStartIndex(t, e, n) {
        var r = t.direction,
            o = t.height,
            i = t.itemCount,
            s = t.itemSize,
      ...
      initInstanceProps: function initInstanceProps(t) {},
  ...
  95257: function _(t, e) {
    ...
    function M(t, e, r) {
      var o,
          ...
          s = null,
          a = null;
      if (null != e) for (o in void 0 !== e.ref && (a = e.ref), void 0 !== e.key && (s = "" + e.key), e) {
    ...
    function E(t) {
      return "object" == _typeof(t) && null !== t && t.$$typeof === n;
    }
    ...
    function z(t, e, o, i, s) {
      ...
      if (c) return s = s(c = t), t = "" === i ? "." + R(c, 0) : i, S(s) ? (o = "", null != t && (o = t.replace(x, "$&/") + "/"), z(s, e, o, "", function (t) {
        return t;
      ...
      }(s, o + (!s.key || c && c.key === s.key ? "" : ("" + s.key).replace(x, "$&/") + "/") + t)), e.push(s)), 1;
      if (c = 0, i = "" === i ? "." : i + ":", S(t)) for (var u = 0; u < t.length; u++) {
        var l = i + R(a = t[u], u);
        c += z(a, e, o, l, s);
      } else if (l = function (t) {
        return null === t || "object" != _typeof(t) ? null : "function" == typeof (t = d && t[d] || t["@@iterator"]) ? t : null;
      }(t), "function" == typeof l) for (t = l.call(t), u = 0; !(a = t.next()).done;) {
    ...
    e.Children = {
    ...
    }, e.Component = _, e.Fragment = o, e.Profiler = s, e.PureComponent = g, e.StrictMode = i, e.Suspense = l, e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = A, e.cloneElement = function (t, e, r) {
      ...
      if (null != e) {
        if (void 0 !== e.ref && (s = e.ref, a = O.current), void 0 !== e.key && (i = "" + e.key), t.type && t.type.defaultProps) var c = t.type.defaultProps;

        for (u in e) {
          w.call(e, u) && !I.hasOwnProperty(u) && (o[u] = void 0 === e[u] && void 0 !== c ? c[u] : e[u]);
        }
      }
