...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[5899], {
  70048: function _(e) {
    e.exports = {
  ...
  70673: function _(e, t, n) {
    ...
    function u(e) {
      ...
      var t = o(c().box, c()["intent-".concat(e.intent)], (_o = {}, _defineProperty(_o, c().check, !Boolean(e.indeterminate)), _defineProperty(_o, c().dot, Boolean(e.indeterminate)), _defineProperty(_o, c().noOutline, -1 === e.tabIndex), _o)),
      ...
      }, (0, s.filterDataProps)(e))), r.createElement("span", {
        className: t
  ...
  26996: function _(e, t, n) {
    ...
    function (_o$PureComponent) {
      ...
      function c(e) {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(c).call(this, e)), _this._stateChangeTimeout = null, _this.state = {
          state: r.Initial
        };
        return _this;
      }
  ...
  29332: function _(e, t, n) {
    ...
    n.d(t, {
      ...
      OverlapContextMenu: function OverlapContextMenu() {
        return g;
      }
    });
    var r = n(50959),
    ...
    function _(e) {
      ...
      return (0, r.useEffect)(function () {
        ...
        return t.onUpdate().subscribe(null, e), function () {
          t.onUpdate().unsubscribe(null, e);
        };
      }, []), r.createElement(f.ContextMenuItem, _objectSpread({}, n, {
    ...
    function y(e) {
      var t = e.items,
          n = e.parentAction,
          o = e.closeNested,
          s = !Boolean(n) && t.every(function (e) {
        return !Boolean("separator" !== e.type && (e.getState().icon || e.getState().checkable));
      });
      return r.createElement(E.EmptyIconsContext.Provider, {
        value: s
      }, r.createElement("ul", null, n && r.createElement(r.Fragment, null, r.createElement(f.ContextMenuItem, {
        ...
        icon: k,
        onClick: o
      }), r.createElement(m, null)), t.map(function (e) {
        switch (e.type) {
          case "action":
    ...
    function (_r$PureComponent) {
      ...
      function x(e) {
        ...
        _this3 = _possibleConstructorReturn(this, _getPrototypeOf(x).call(this, e)), _this3._menuRef = r.createRef(), _this3._handleRequestUpdate = function () {
          _this3.update();
        }, _this3._handleClose = function () {
          _this3.props.onClose && _this3.props.onClose();
        }, _this3._handleOutsideClickClose = function (e) {
          var _this3$props = _this3.props,
              t = _this3$props.doNotCloseOn,
              n = _this3$props.onClose;
          !n || void 0 !== t && t.contains(e.target) || n();
        }, _this3._handleFocusOnOpen = function () {
          var e, t;
          (null === (e = _this3.props.menuElementReference) || void 0 === e ? void 0 : e.current) && _this3.props.takeFocus && (null === (t = _this3.props.menuElementReference) || void 0 === t || t.current.focus({
            preventScroll: !0
          }));
        }, _this3.state = {};
        return _this3;
      ...
      _createClass(x, [{
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
              e = _this$props2.isOpened,
              t = _this$props2.onClose,
              n = _this$props2.items,
              o = _this$props2.doNotCloseOn,
              a = _this$props2.menuStatName,
              d = _this$props2.parentStatName,
              m = _this$props2.takeFocus,
              f = _objectWithoutProperties(_this$props2, ["isOpened", "onClose", "items", "doNotCloseOn", "menuStatName", "parentStatName", "takeFocus"]);

          return e ? r.createElement(h.DrawerManager, null, r.createElement(c.KeyboardDocumentListener, {
            keyCode: 27,
            eventType: "keyup",
            handler: this._handleClose
          }), r.createElement(p.MatchMedia, {
            rule: "screen and (max-width: 430px)"
          }, function (t) {
            return _this4._isDrawer(t) ? r.createElement(C.Provider, {
              value: {
                type: "drawer"
              }
            }, r.createElement(v.Drawer, {
              onClose: _this4._handleClose,
              position: "Bottom",
            ...
            }, r.createElement(l.OutsideEvent, {
              handler: _this4._handleOutsideClickClose,
              mouseDown: !0,
              touchStart: !0,
              reference: _this4.props.menuElementReference
            }, function (t) {
              return r.createElement(i.Menu, _objectSpread({}, f, {
                reference: t,
                ...
                ref: _this4._menuRef,
                tabIndex: m ? -1 : void 0,
                onOpen: _this4._handleFocusOnOpen
              }), r.createElement(u.ActionsTable, {
                items: n,
                menuStatName: a,
                parentStatName: d,
                parentIsOpened: e,
                onRequestUpdate: _this4._handleRequestUpdate
              }));
            }));
          })) : null;
        }
    ...
    var g = (0, a.makeOverlapable)(x);
  },
  99025: function _(e, t, n) {
    "use strict";
    ...
    function i(e) {
      var _e$text = e.text,
          ...
          n = e.className;
      return r.createElement("span", {
        className: s()(a.shortcut, n)
      }, t);
    }
  },
  23829: function _(e, t, n) {
    "use strict";
    ...
    function m(e) {
      var t = e.className,
          ...
          I = e.jsxLabel,
          _e$size = e.size,
          N = _e$size === void 0 ? "normal" : _e$size,
          M = (0, r.useContext)(l.EmptyIconsContext),
          O = !!C.length;
      return o ? r.createElement("li", {
        className: s()(t, d.item, d.loading, d[N])
      }, r.createElement(i.Loader, null)) : r.createElement("li", {
        className: s()(t, d.item, d.interactive, n && d.title, b && d.disabled, m && d.hovered, f && d.active, M && d.emptyIcons, d[N]),
        onClick: x
      }, r.createElement(a.Icon, {
        className: s()(d.icon),
        icon: function () {
        ...
        className: s()(d.label)
      }, null != I ? I : w), !!S && r.createElement(a.Icon, {
        onClick: function onClick() {
          S && S.action();
        },
        className: d.remove,
        icon: p
      }), !O && y && r.createElement(c.Hint, {
        className: d.shortcut,
        text: y
      }), O && r.createElement(a.Icon, {
        className: d.nested,
        icon: h
      }), g);
    }
  },
  54627: function _(e, t, n) {
    "use strict";
    ...
    var r = n(50959).createContext(!1);
  },
  9481: function _(e, t, n) {
    "use strict";
    ...
    function (_r$PureComponent2) {
      ...
      function o() {
        ...
        _this5 = _possibleConstructorReturn(this, _getPrototypeOf(o).apply(this, arguments)), _this5._handleKeyDown = function (e) {
          e.keyCode === _this5.props.keyCode && _this5.props.handler(e);
        };
        return _this5;
      }
          ...
          _createClass(_class, [{
            ...
            value: function render() {
              var _this$props3 = this.props,
                  t = _this$props3.isOpened,
                  n = _this$props3.root;
              if (!t) return null;
              var s = r.createElement(e, _objectSpread({}, this.props, {
                zIndex: 150
              }));
  ...
  96040: function _(e, t, n) {
    ...
    function c(e) {
      ...
      return o.createElement(a.Icon, _objectSpread({}, f, {
        "data-name": m,
        className: s(l.button, "apply-common-tooltip", c && l.active, d && l.hidden, t),
        icon: i,
        onClick: u,
        onMouseDown: h,
  ...
  95257: function _(e, t) {
    ...
    function g(e, t, r) {
      var o,
          ...
          a = null,
          i = null;
      if (null != t) for (o in void 0 !== t.ref && (i = t.ref), void 0 !== t.key && (a = "" + t.key), t) {
    ...
    function M(e, t, o, s, a) {
      ...
      if (l) return a = a(l = e), e = "" === s ? "." + N(l, 0) : s, y(a) ? (o = "", null != e && (o = e.replace(I, "$&/") + "/"), M(a, t, o, "", function (e) {
        return e;
      ...
      }(a, o + (!a.key || l && l.key === a.key ? "" : ("" + a.key).replace(I, "$&/") + "/") + e)), t.push(a)), 1;
      if (l = 0, s = "" === s ? "." : s + ":", y(e)) for (var c = 0; c < e.length; c++) {
        var u = s + N(i = e[c], c);
        l += M(i, t, o, u, a);
      } else if (u = function (e) {
        return null === e || "object" != _typeof(e) ? null : "function" == typeof (e = d && e[d] || e["@@iterator"]) ? e : null;
      }(e), "function" == typeof u) for (e = u.call(e), c = 0; !(i = e.next()).done;) {
    ...
    t.Children = {
    ...
    }, t.Component = b, t.Fragment = o, t.Profiler = a, t.PureComponent = E, t.StrictMode = s, t.Suspense = u, t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = G, t.cloneElement = function (e, t, r) {
      ...
      if (null != t) {
        if (void 0 !== t.ref && (a = t.ref, i = w.current), void 0 !== t.key && (s = "" + t.key), e.type && e.type.defaultProps) var l = e.type.defaultProps;
  ...
  58451: function _(e, t, n) {
    "use strict";

    n.d(t, {
      ActionsTable: function ActionsTable() {
        return M;
      }
    });
    var r = n(50959),
    ...
    function (_r$PureComponent4) {
      ...
      function E() {
        ...
        _this6 = _possibleConstructorReturn(this, _getPrototypeOf(E).apply(this, arguments)), _this6._handleMouseOver = function (e) {
          (function (e) {
            var t = e.sourceCapabilities;
            var n = t && t.firesTouchEvents;
            return void 0 === n && (n = h.touch), n;
          })(e.nativeEvent) || _this6.props.onMouseOver && _this6.props.onMouseOver();
        }, _this6._handleClickToolbox = function (e) {
          e.stopPropagation(), _this6.props.onClickToolbox && _this6.props.onClickToolbox();
        };
        return _this6;
      }
      ...
      _createClass(E, [{
        ...
        value: function render() {
          var _this$props4 = this.props,
              e = _this$props4.hasSubItems,
              t = _this$props4.shortcutHint,
              n = _this$props4.hint,
              o = _this$props4.invisibleHotkey,
              s = _this$props4.favourite,
              _this$props4$theme = _this$props4.theme,
              a = _this$props4$theme === void 0 ? _ : _this$props4$theme,
              _this$props4$size = _this$props4.size,
              l = _this$props4$size === void 0 ? "normal" : _this$props4$size,
              c = this.props.checkable && this.props.checkboxInput ? "label" : "div";
          return r.createElement(r.Fragment, null, r.createElement("tr", {
            className: i(this.props.className, a.item, !this.props.noInteractive && a.interactive, this.props.hovered && a.hovered, this.props.disabled && a.disabled, this.props.active && a.active, this.props.selected && a.selected, a[l]),
            onClick: this.props.onClick,
            onMouseOver: this._handleMouseOver,
            ref: this.props.reference,
            "data-action-name": this.props.actionName
          }, void 0 !== s && r.createElement("td", null, r.createElement(d.FavoriteButton, {
            className: a.favourite,
            isFilled: s,
            onClick: this.props.onFavouriteClick
          })), r.createElement("td", {
            className: i(a.iconCell),
            "data-icon-cell": !0
          }, this._icon(a)), r.createElement("td", {
            ...
            "data-label": !0
          }, this.props.label), this._toolbox(a), e && r.createElement("span", {
            className: a.arrowIcon,
            dangerouslySetInnerHTML: {
              __html: b
            },
            "data-submenu-arrow": !0
          }), !e && t && !u.CheckMobile.any() && r.createElement(m.Hint, {
            className: i(o && a.invisibleHotkey),
            text: t
          }), !e && !t && n && r.createElement(m.Hint, {
            text: n
          })))), r.createElement("tr", {
            className: a.subMenu
        ...
        key: "_icon",
        value: function _icon(e) {
          if (this.props.checkable) {
            if (this.props.checkboxInput) return r.createElement(c.CheckboxInput, {
              className: i(e.icon, e.checkboxInput),
              checked: this.props.checked
            });

            if (this.props.checked) {
              var _t = !this.props.icon && !this.props.iconChecked,
                  _n2 = this.props.iconChecked || this.props.icon || v;

              return r.createElement("span", {
                className: i(e.icon, _t && e.checkmark),
                dangerouslySetInnerHTML: {
                  __html: _n2
                },
                "data-icon-checkmark": _t
              });
            }

            return this.props.icon ? r.createElement("span", {
              className: e.icon,
              dangerouslySetInnerHTML: {
        ...
        key: "_toolbox",
        value: function _toolbox(e) {
          return this.props.toolbox ? r.createElement("span", {
        ...
        key: "_renderToolboxContent",
        value: function _renderToolboxContent() {
          return this.props.toolbox && this.props.toolbox.type === f.ToolboxType.Delete ? r.createElement(p.RemoveButton, {
    ...
    function I(e) {
      var _e$size2 = e.size,
          t = _e$size2 === void 0 ? "normal" : _e$size2;
      return r.createElement(E, {
        size: t,
        label: r.createElement("div", {
          className: l()(S.loaderWrap, S[t])
        }, r.createElement(g.Loader, {
          className: S.loader
        })),
        noInteractive: !0,
    ...
    function (_r$PureComponent5) {
      ...
      function N(e) {
        ...
        _this7 = _possibleConstructorReturn(this, _getPrototypeOf(N).call(this, e)), _this7._itemRef = null, _this7._menuElementRef = r.createRef(), _this7._menuRef = null, _this7._handleClick = function (e) {
          e.isDefaultPrevented() || _this7.state.disabled || (_this7._hasSubItems() ? _this7._showSubMenu() : (_this7.state.doNotCloseOnClick || (0, y.globalCloseMenu)(), _this7.props.action.execute(), _this7._trackEvent(), _this7.props.onExecute && _this7.props.onExecute(_this7.props.action)));
        }, _this7._handleClickToolbox = function () {
          (0, y.globalCloseMenu)();
        }, _this7._handleItemMouseOver = function () {
          _this7._showSubMenu(), _this7._setCurrentContextValue();
        }, _this7._handleMenuMouseOver = function () {
          _this7._setCurrentContextValue();
        }, _this7._showSubMenu = function () {
          _this7.props.onShowSubMenu(_this7.props.action);
        }, _this7._calcSubMenuPos = function (e) {
          return function (e, t) {
            ...
            if (t) {
              var _t$getBoundingClientR = t.getBoundingClientRect(),
                  _n3 = _t$getBoundingClientR.left,
                  _r = _t$getBoundingClientR.right,
                  _o2 = _t$getBoundingClientR.top,
                  _s2 = document.documentElement.clientWidth,
                  _a = {
                x: _n3 - e,
                y: _o2
              },
              ...
              return (0, w.isRtl)() ? _n3 <= e ? _i2 : _a : _s2 - _r >= e ? _i2 : _a;
            }

            return n;
          }(e, _this7._itemRef);
        }, _this7._updateState = function (e) {
          _this7.setState(e.getState());
        }, _this7._setItemRef = function (e) {
          _this7._itemRef = e;
        }, _this7._handleMenuRef = function (e) {
          _this7._menuRef = e;
        }, _this7._registerSubmenu = function () {
          var e;
          return null === (e = _this7.context) || void 0 === e ? void 0 : e.registerSubmenu(_this7.props.action.id, function (e) {
            return (0, a.ensureNotNull)(_this7._itemRef).contains(e) || null !== _this7._menuElementRef.current && _this7._menuElementRef.current.contains(e);
          });
        }, _this7.state = _objectSpread({}, _this7.props.action.getState());
        return _this7;
      }
      ...
      _createClass(N, [{
        ...
        value: function render() {
          var e, t, n;
          var o = null !== (e = this.state.jsxLabel) && void 0 !== e ? e : this.state.label,
              s = (null === (t = this.context) || void 0 === t ? void 0 : t.current) ? this.context.current === this.props.action.id : this.props.isSubMenuOpened;
          return this.state.loading ? r.createElement(I, {
            size: this.state.size
          }) : r.createElement(E, _objectSpread({
        ...
        key: "_setCurrentContextValue",
        value: function _setCurrentContextValue() {
          var e;
          this.state.subItems.length && (null === (e = this.context) || void 0 === e || e.setCurrent(this.props.action.id));
        }
      }, {
        key: "_hasSubItems",
        value: function _hasSubItems() {
          return this.state.subItems.length > 0;
        }
      }, {
        key: "_trackEvent",
        value: function _trackEvent() {
          var e = this._getStatName();

          (0, C.trackEvent)("ContextMenuClick", this.props.menuStatName || "", e);
        }
      }, {
        key: "_getStatName",
        value: function _getStatName() {
    ...
    function (_r$PureComponent6) {
      ...
      function M(e) {
        ...
        _this8 = _possibleConstructorReturn(this, _getPrototypeOf(M).call(this, e)), _this8._handleShowSubMenu = function (e) {
          var t = e.getState();
      ...
      _createClass(M, [{
        ...
        value: function render() {
          ...
          return r.createElement("table", null, r.createElement("tbody", null, this.props.items.map(function (e) {
            return _this9._item(e);
          })));
        }
      }, {
        key: "_item",
        value: function _item(e) {
          switch (e.type) {
            case "separator":
