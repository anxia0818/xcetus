...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[306, 8115], {
  59255: function _(t, e, n) {
    ...
    var r = function () {
      ...
      return function () {
        ...
        u = "function" == typeof requestAnimationFrame ? requestAnimationFrame.bind(i) : function (t) {
    ...
    function v(t) {
      ...
      if ("border-box" === r.boxSizing && (Math.round(s + i) !== e && (s -= d(r, "left", "right") + i), Math.round(c + u) !== n && (c -= d(r, "top", "bottom") + u)), !function (t) {
    ...
    var m = function () {
      ...
      var n,
          ...
          s,
          c,
          a = (r = (n = e).x, o = n.y, i = n.width, u = n.height, s = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, c = Object.create(s.prototype), f(c, {
        x: r,
        y: o,
        width: i,
        height: u,
  ...
  95257: function _(t, e) {
    ...
    function C(t, e, o, i, u) {
      ...
      if (c) return u = u(c = t), t = "" === i ? "." + A(c, 0) : i, g(u) ? (o = "", null != t && (o = t.replace(M, "$&/") + "/"), C(u, e, o, "", function (t) {
        return t;
      ...
      }(u, o + (!u.key || c && c.key === u.key ? "" : ("" + u.key).replace(M, "$&/") + "/") + t)), e.push(u)), 1;
      ...
      }(t), "function" == typeof f) for (t = f.call(t), a = 0; !(s = t.next()).done;) {
    ...
    e.Children = {
    ...
    }, e.Component = y, e.Fragment = o, e.Profiler = u, e.PureComponent = m, e.StrictMode = i, e.Suspense = f, e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = D, e.cloneElement = function (t, e, r) {
      ...
      if (null != e) {
        if (void 0 !== e.ref && (u = e.ref, s = O.current), void 0 !== e.key && (i = "" + e.key), t.type && t.type.defaultProps) var c = t.type.defaultProps;
