...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[2020], {
  59142: function _(o, e) {
    var l, i, n;
    i = [e], l = function l(o) {
      "use strict";
      ...
      var n = "undefined" != typeof window && window.navigator && window.navigator.platform && /iP(ad|hone|od)/.test(window.navigator.platform),
        ...
        return !!d(e.target) || 1 < e.touches.length || (e.preventDefault && e.preventDefault(), !1);
          ...
          L = function L() {
        setTimeout(function () {
          void 0 !== r && (document.body.style.paddingRight = r, r = void 0), void 0 !== c && (document.body.style.overflow = c, c = void 0);
        });
      };
      ...
      o.disableBodyScroll = function (o, i) {
        if (n) {
          ...
          if (o && !a.some(function (e) {
            ...
            a = [].concat(e(a), [L]), o.ontouchstart = function (o) {
              1 === o.targetTouches.length && (s = o.targetTouches[0].clientY);
            }, o.ontouchmove = function (e) {
              var l, i, n, a;
              1 === e.targetTouches.length && (i = o, a = (l = e).targetTouches[0].clientY - s, !d(l.target) && (i && 0 === i.scrollTop && 0 < a || (n = i) && n.scrollHeight - n.scrollTop <= n.clientHeight && a < 0 ? T(l) : l.stopPropagation()));
            }, t || (document.addEventListener("touchmove", T, l ? {
              passive: !1
            } : void 0), t = !0);
          }
        } else {
          m = i, setTimeout(function () {
            if (void 0 === r) {
              ...
              o && 0 < e && (r = document.body.style.paddingRight, document.body.style.paddingRight = e + "px");
            }
        ...
        }), t && (document.removeEventListener("touchmove", T, l ? {
          passive: !1
        } : void 0), t = !1), a = [], s = -1) : (L(), a = []);
      }, o.enableBodyScroll = function (o) {
        if (n) {
          if (!o) return void console.error("enableBodyScroll unsuccessful - targetElement must be provided when calling enableBodyScroll on IOS devices.");
          o.ontouchstart = null, o.ontouchmove = null, a = a.filter(function (e) {
            return e.targetElement !== o;
          }), t && 0 === a.length && (document.removeEventListener("touchmove", T, l ? {
            passive: !1
          } : void 0), t = !1);
        } else 1 === a.length && a[0].targetElement === o ? (L(), a = []) : a = a.filter(function (e) {
          return e.targetElement !== o;
        });
      };
  ...
  36189: function _(o, e, l) {
    ...
    function T(o) {
      var e = o.className,
          ...
          i = o.isActive,
          T = o.onClick,
          L = _objectWithoutProperties(o, ["className", "isFilled", "isActive", "onClick"]);

      return n.createElement(t.Icon, _objectSpread({}, L, {
  ...
  66427: function _(o, e, l) {
    "use strict";

    l.d(e, {
      ToolButton: function ToolButton() {
        return s;
      }
    });
    var i = l(50959),
        ...
        a = l(9745),
        t = l(54784);
    var s = (0, i.forwardRef)(function (o, e) {
      var _n;
      ...
      var l = o.id,
          ...
          m = o.isTransparent,
          _o$theme = o.theme,
          v = _o$theme === void 0 ? t : _o$theme,
          z = o.onClick,
          g = o.onKeyDown,
          w = o.buttonHotKey,
          _o$tooltipPosition = o.tooltipPosition,
          u = _o$tooltipPosition === void 0 ? "vertical" : _o$tooltipPosition,
          _o$tag = o.tag,
          f = _o$tag === void 0 ? "div" : _o$tag,
          N = o.tabIndex,
          p = o.tooltip,
          I = _objectWithoutProperties(o, ["id", "activeClass", "children", "className", "icon", "isActive", "isGrayed", "isHidden", "isTransparent", "theme", "onClick", "onKeyDown", "buttonHotKey", "tooltipPosition", "tag", "tabIndex", "tooltip"]),
          A = "button" === o.tag;

      return i.createElement(f, _objectSpread({
        "aria-label": A ? p : void 0
      }, I, {
        id: l,
        type: A ? "button" : void 0,
        className: n(v.button, r, T && s, (_n = {
          "apply-common-tooltip": Boolean(p),
          "common-tooltip-vertical": Boolean(p) && "vertical" === u
        }, _defineProperty(_n, v.isActive, T), _defineProperty(_n, v.isGrayed, L), _defineProperty(_n, v.isHidden, h), _defineProperty(_n, v.isTransparent, m), _n), A && v.accessible),
        onClick: z,
        onKeyDown: g,
        ...
        className: v.bg
      }, d && ("string" == typeof d ? i.createElement(a.Icon, {
        className: v.icon,
        icon: d
  ...
  87872: function _(o, e, l) {
    "use strict";

    l.d(e, {
      drawingToolsIcons: function drawingToolsIcons() {
        return i;
      }
    });
    var i = {
  ...
  54819: function _(o, e, l) {
    "use strict";

    l.d(e, {
      lineToolsInfo: function lineToolsInfo() {
        return v;
      }
    });
    var i = l(44352),
        ...
        s = l(59656),
        c = l(68335);
    var r = (0, c.humanReadableModifiers)(c.Modifiers.Shift, !1),
        d = (0, c.humanReadableModifiers)(c.Modifiers.Alt, !1),
        T = (0, c.humanReadableModifiers)(c.Modifiers.Mod, !1),
        L = {
      keys: [r],
      text: i.t(null, void 0, l(40234))
    },
        h = {
      keys: [r],
      text: i.t(null, void 0, l(68125))
    },
        m = {
      keys: [r],
  ...
  71810: function _(o, e, l) {
    "use strict";

    l.d(e, {
      LinetoolsFavoritesStore: function LinetoolsFavoritesStore() {
        return s;
      }
    });
    var i = l(57898),
        n = l(56840);
    var a = ["LineToolBalloon"];
    var t, s;
    !function (o) {
      function e() {
        var e, i;
        o.favorites = [];
        var s = !1;
        var c = Boolean(void 0 === (0, n.getValue)("chart.favoriteDrawings")),
            r = (0, n.getJSON)("chart.favoriteDrawings", []);

        if (0 === r.length && c && "undefined" != typeof window) {
          var _o = JSON.parse(null !== (i = null === (e = window.urlParams) || void 0 === e ? void 0 : e.favorites) && void 0 !== i ? i : "{}").drawingTools;
          _o && Array.isArray(_o) && r.push.apply(r, _toConsumableArray(_o));
        }

        r.forEach(function (e, i) {
          var n = e.tool || e;
          l(n) ? a.includes(n) ? s = !0 : o.favorites.push(n) : "LineToolTweet" === n && (o.tweetToolPosition = i);
        }), s && t(), o.favoritesSynced.fire();
      }
      ...
      function t(e) {
        var l = o.favorites.slice();
        null !== o.tweetToolPosition && l.splice(o.tweetToolPosition, 0, "LineToolTweet"), (0, n.setJSON)("chart.favoriteDrawings", l, e);
      }

      o.favorites = [], o.favoritesSynced = new i.Delegate(), o.tweetToolPosition = null, o.favoriteIndex = function (e) {
        return o.favorites.indexOf(e);
      }, o.isValidLineToolName = l, o.saveFavorites = t, e(), n.onSync.subscribe(null, e);
    }(t || (t = {})), function (o) {
      function e(o) {
      ...
      o.favoriteAdded = new i.Delegate(), o.favoriteRemoved = new i.Delegate(), o.favoriteMoved = new i.Delegate(), o.favoritesSynced = t.favoritesSynced, o.favorites = function () {
        return t.favorites.slice();
      }, o.isValidLineToolName = e, o.favoritesCount = l, o.favorite = function (o) {
        return o < 0 || o >= l() ? "" : t.favorites[o];
      }, o.addFavorite = function (l, i) {
        return !(n(l) || !e(l)) && (t.favorites.push(l), t.saveFavorites(i), o.favoriteAdded.fire(l), !0);
      }, o.removeFavorite = function (e, l) {
        var i = t.favoriteIndex(e);
        if (-1 === i) return !1;
        t.favorites.splice(i, 1);
        var n = t.tweetToolPosition;
        return null !== n && n > i && (t.tweetToolPosition = n - 1), t.saveFavorites(l), o.favoriteRemoved.fire(e), !0;
      }, o.isFavorite = n, o.moveFavorite = function (i, n, a) {
        if (n < 0 || n >= l() || !e(i)) return !1;
        var s = t.favoriteIndex(i);
        if (-1 === s || n === s) return !1;
        var c = t.tweetToolPosition;
        return null !== c && (s < c && n > c ? c-- : n < c && s > c && c++, t.tweetToolPosition = c), t.favorites.splice(s, 1), t.favorites.splice(n, 0, i), t.saveFavorites(a), o.favoriteMoved.fire(i, s, n), !0;
      };
    }(s || (s = {}));
  },
  19799: function _(o) {
  ...
  10862: function _(o) {
    o.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path fill="currentColor" fill-rule="evenodd" d="M24.13 14.65a6.2 6.2 0 0 0-.46-9.28c-2.57-2.09-6.39-1.71-8.75.6l-.92.91-.92-.9c-2.36-2.32-6.18-2.7-8.75-.61a6.2 6.2 0 0 0-.46 9.28l9.07 8.92c.58.57 1.53.57 2.12 0l9.07-8.92Zm-9.77 8.2 9.07-8.91a5.2 5.2 0 0 0-.39-7.8c-2.13-1.73-5.38-1.45-7.42.55L14 8.29l-1.62-1.6c-2.03-2-5.29-2.28-7.42-.55a5.2 5.2 0 0 0-.4 7.8l9.08 8.91c.2.2.52.2.72 0Z"/></svg>';
  },
  68385: function _(o) {
  ...
  91244: function _(o) {
    o.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path fill="currentColor" fill-rule="evenodd" d="M14 6a3 3 0 0 0-3 3v3h8.5a2.5 2.5 0 0 1 2.5 2.5v7a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 6 21.5v-7A2.5 2.5 0 0 1 8.5 12H10V9a4 4 0 0 1 8 0h-1a3 3 0 0 0-3-3zm-1 11a1 1 0 1 1 2 0v2a1 1 0 1 1-2 0v-2zm-6-2.5c0-.83.67-1.5 1.5-1.5h11c.83 0 1.5.67 1.5 1.5v7c0 .83-.67 1.5-1.5 1.5h-11A1.5 1.5 0 0 1 7 21.5v-7z"/></svg>';
  },
  45820: function _(o) {
  ...
  14665: function _(o) {
    o.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 16" width="10" height="16"><path d="M.6 1.4l1.4-1.4 8 8-8 8-1.4-1.4 6.389-6.532-6.389-6.668z"/></svg>';
  },
  39146: function _(o) {
    o.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" width="18" height="18" fill="none"><path fill="currentColor" d="M9 1l2.35 4.76 5.26.77-3.8 3.7.9 5.24L9 13l-4.7 2.47.9-5.23-3.8-3.71 5.25-.77L9 1z"/></svg>';
  },
  48010: function _(o) {
    o.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" width="18" height="18" fill="none"><path stroke="currentColor" d="M9 2.13l1.903 3.855.116.236.26.038 4.255.618-3.079 3.001-.188.184.044.259.727 4.237-3.805-2L9 12.434l-.233.122-3.805 2.001.727-4.237.044-.26-.188-.183-3.079-3.001 4.255-.618.26-.038.116-.236L9 2.13z"/></svg>';
  }
}]);