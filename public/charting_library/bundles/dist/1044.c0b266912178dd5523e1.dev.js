...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[1044, 8115, 306], {
  59255: function _(t, e, n) {
    ...
    function y(t) {
      ...
      if ("border-box" === r.boxSizing && (Math.round(u + i) !== e && (u -= d(r, "left", "right") + i), Math.round(c + s) !== n && (c -= d(r, "top", "bottom") + s)), !function (t) {
    ...
    var m = function () {
      ...
      var n,
          ...
          u,
          c,
          a = (r = (n = e).x, o = n.y, i = n.width, s = n.height, u = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, c = Object.create(u.prototype), f(c, {
        x: r,
        y: o,
        width: i,
        height: s,
  ...
  95257: function _(t, e) {
    ...
    function v(t, e, n) {
      this.props = t, this.context = e, this.refs = _, this.updater = n || d;
    }
    ...
    function R(t, e, r) {
      var o,
          ...
          s = null,
          u = null;
      if (null != e) for (o in void 0 !== e.ref && (u = e.ref), void 0 !== e.key && (s = "" + e.key), e) {
    ...
    function x(t, e, o, i, s) {
      ...
      if (c) return s = s(c = t), t = "" === i ? "." + C(c, 0) : i, g(s) ? (o = "", null != t && (o = t.replace(T, "$&/") + "/"), x(s, e, o, "", function (t) {
        return t;
      ...
      }(s, o + (!s.key || c && c.key === s.key ? "" : ("" + s.key).replace(T, "$&/") + "/") + t)), e.push(s)), 1;
      if (c = 0, i = "" === i ? "." : i + ":", g(t)) for (var a = 0; a < t.length; a++) {
        var f = i + C(u = t[a], a);
        c += x(u, e, o, f, s);
      } else if (f = function (t) {
        return null === t || "object" != _typeof(t) ? null : "function" == typeof (t = p && t[p] || t["@@iterator"]) ? t : null;
      }(t), "function" == typeof f) for (t = f.call(t), a = 0; !(u = t.next()).done;) {
    ...
    e.Children = {
    ...
    }, e.Component = v, e.Fragment = o, e.Profiler = s, e.PureComponent = m, e.StrictMode = i, e.Suspense = f, e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = P, e.cloneElement = function (t, e, r) {
      ...
      if (null != e) {
        if (void 0 !== e.ref && (s = e.ref, u = O.current), void 0 !== e.key && (i = "" + e.key), t.type && t.type.defaultProps) var c = t.type.defaultProps;

        for (a in e) {
          E.call(e, a) && !S.hasOwnProperty(a) && (o[a] = void 0 === e[a] && void 0 !== c ? c[a] : e[a]);
        }
      }
    ...
    }, e.createElement = R, e.createFactory = function (t) {
      var e = R.bind(null, t);
      return e.type = t, e;
