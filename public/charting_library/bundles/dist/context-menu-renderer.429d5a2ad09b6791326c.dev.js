...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[1584], {
        ...
        if (r) {
          ...
          if (e && !i.some(function (t) {
            ...
            i = [].concat(t(i), [h]), e.ontouchstart = function (e) {
              ...
              var o, n, r, i;
              1 === t.targetTouches.length && (n = e, i = (o = t).targetTouches[0].clientY - a, !d(o.target) && (n && 0 === n.scrollTop && 0 < i || (r = n) && r.scrollHeight - r.scrollTop <= r.clientHeight && i < 0 ? u(o) : o.stopPropagation()));
  ...
  41590: function _(e, t, o) {
    ...
    function h(e) {
      ...
      return (0, n.useLayoutEffect)(function () {
        return (0, r.ensureNotNull)(w.current).focus({
          preventScroll: !0
        }), g.subscribe(f, o), f.addDrawer(p), function () {
      ...
      }, p === f.currentDrawer && n.createElement("div", {
    ...
    var v = (0, n.forwardRef)(function (e, t) {
      var o = e.className,
  ...
  36189: function _(e, t, o) {
    ...
    function u(e) {
      ...
      return r.createElement(s.Icon, _objectSpread({}, h, {
  ...
  86656: function _(e, t, o) {
    ...
    var a = (0, n.forwardRef)(function (e, t) {
      ...
      return (0, n.useImperativeHandle)(t, function () {
        ...
        if (s.CheckMobile.iOS()) return null !== a.current && (0, r.disableBodyScroll)(a.current, {
          allowTouchMove: l(a)
        }), function () {
  ...
  20323: function _(e, t, o) {
    "use strict";

    o.r(t), o.d(t, {
      ContextMenuRenderer: function ContextMenuRenderer() {
        return l;
      }
    });
    var n = o(50959),
    ...
    function () {
      function l(e, t, o, r) {
        ...
        }, this._onDestroy = o, this._onShow = r, this._activeElement = document.activeElement, this._returnFocus = t.returnFocus, this._takeFocus = t.takeFocus, this._menuElementRef = n.createRef(), this._doNotCloseOn = t.doNotCloseOn, t.manager && (this._manager = t.manager);
      }
      ...
      _createClass(l, [{
        ...
        value: function show(e) {
          ...
          this._onShow && this._onShow(), this._isShown = !0, this._render(_objectSpread({}, this._props, {
            position: function position(t, o, n, r) {
              var i, a, l, c, d, u, h;
              var v;
              if (void 0 !== e.box) v = e.box;else {
                v = {
                  x: null !== (a = null === (i = e.touches) || void 0 === i ? void 0 : i[0].clientX) && void 0 !== a ? a : e.clientX,
                  y: null !== (c = null === (l = e.touches) || void 0 === l ? void 0 : l[0].clientY) && void 0 !== c ? c : e.clientY,
                  w: 0,
                  h: 0
                };
              }
              var m = null !== (d = e.marginX) && void 0 !== d ? d : 0,
                  f = null !== (u = e.marginY) && void 0 !== u ? u : 0;
              var p, w;

              switch (p = void 0 === e.attachToXBy ? (0, s.isRtl)() ? "right" : "left" : "auto" === e.attachToXBy ? (0, s.isRtl)() ? v.x - m - t >= 0 ? "right" : "left" : v.x + v.w + m + t <= n ? "left" : "right" : e.attachToXBy, p) {
                case "left":
                  w = v.x + v.w + m;
                  break;
              ...
              "auto-strict" === _ && (_ = r < v.y + v.h + f + o ? "bottom" : "top");
              var y = v.y;
              ...
              switch (_) {
                ...
                case "bottom":
                  y = Math.max(0, v.y - f - o), g = 0 === y ? v.y - f : void 0;
              }
        ...
        key: "hide",
        value: function hide() {
          this._isShown = !1, this._render(_objectSpread({}, this._props, {
            isOpened: !1
          }));
        }
      }, {
        ...
        value: function _unmount() {
          this._isShown = !1, r.unmountComponentAtNode(this._root), this._onDestroy && this._onDestroy(), this._returnFocus && this._activeElement instanceof HTMLElement && this._activeElement.focus({
            preventScroll: !0
          });
        }
      }, {
        ...
        value: function _render(e) {
          r.render(n.createElement(a.SlotContext.Provider, {
            value: this._manager
          }, n.createElement(i.OverlapContextMenu, _objectSpread({}, e))), this._root);
        }
      }]);
