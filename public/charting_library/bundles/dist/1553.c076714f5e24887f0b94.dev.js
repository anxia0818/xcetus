...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[1553], {
  11553: function _(t, e, i) {
    var n;
    !function (r, s, o, a) {
      "use strict";
      ...
      function m(t, e, i) {
        var n;
        if (t) if (t.forEach) t.forEach(e, i);else if (t.length !== a) for (n = 0; n < t.length;) {
          e.call(i, t[n], n, t), n++;
        } else for (n in t) {
      ...
      function U(t, e, i) {
        ...
        i.isFirst = !!s, i.isFinal = !!o, s && (t.session = {}), i.eventType = e, function (t, e) {
          ...
          r > 1 && !i.firstMultiple ? i.firstMultiple = V(e) : 1 === r && (i.firstMultiple = !1);
          var s = i.firstInput,
              o = i.firstMultiple,
      ...
      r.MSPointerEvent && !r.PointerEvent && (nt = "MSPointerDown", rt = "MSPointerMove MSPointerUp MSPointerCancel"), E(st, H, {
        handler: function handler(t) {
          var e = this.store,
              i = !1,
      ...
      function dt() {
        ...
        this.touch = new ft(this.manager, t), this.mouse = new tt(this.manager, t), this.primaryTouch = null, this.lastTouches = [];
      }

      function mt(t, e) {
        1 & t ? (this.primaryTouch = e.changedPointers[0].identifier, gt.call(this, e)) : 12 & t && gt.call(this, e);
      }
      ...
      E(dt, H, {
        handler: function handler(t, e, i) {
          ...
          if (!(r && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
            if (n) mt.call(this, e, i);else if (r && Tt.call(this, i)) return;
            this.callback(t, e, i);
          }
        },
        destroy: function destroy() {
      ...
      Dt.prototype = {
        set: function set(t) {
          t == It && (t = this.compute()), Et && this.manager.element.style && Pt[t] && (this.manager.element.style[yt] = t), this.actions = t.toLowerCase().trim();
        },
      ...
      function xt(t) {
        this.options = h({}, this.defaults, t || {}), this.id = M++, this.manager = null, this.options.enable = C(this.options.enable, !0), this.state = 1, this.simultaneous = {}, this.requireFail = [];
      }
      ...
      xt.prototype = {
        ...
        dropRecognizeWith: function dropRecognizeWith(t) {
          return d(t, "dropRecognizeWith", this) || (t = Mt(t, this), delete this.simultaneous[t.id]), this;
        },
        ...
        process: function process(t) {
          var e = this.state,
              ...
              n = 6 & e,
              r = this.attrTest(t);
          return n && (8 & i || !r) ? 16 | e : n || r ? 4 & i ? 8 | e : 2 & e ? 4 | e : 2 : wt;
        }
      }), E(Nt, zt, {
        defaults: {
          event: "pan",
        ...
        process: function process(t) {
          ...
          if (this._input = t, !n || !i || 12 & t.eventType && !r) this.reset();else if (1 & t.eventType) this.reset(), this._timer = v(function () {
      ...
      function Lt(t, e) {
        var i;
        this.options = h({}, qt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new ((i = this).options.inputClass || (X ? st : Y ? ft : N ? dt : tt))(i, U), this.touchAction = new Dt(this, this.options.touchAction), Ht(this, !0), m(this.options.recognizers, function (t) {
        ...
        recognize: function recognize(t) {
          ...
          if (!e.stopped) {
            ...
            for (var s = 0; s < n.length;) {
              i = n[s], 2 === e.stopped || r && i != r && !i.canRecognizeWith(r) ? i.reset() : i.recognize(t), !r && 14 & i.state && (r = e.curRecognizer = i), s++;
            }
          }
        },
        get: function get(t) {
