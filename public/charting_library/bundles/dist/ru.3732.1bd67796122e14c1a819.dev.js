...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[3732], {
  ...
  673: function _(t) {
    t.exports = Object.create(null), t.exports.d_dates = ["д"], t.exports.h_dates = ["ч"], t.exports.m_dates = ["м"], t.exports.s_dates = ["с"], t.exports.in_dates = ["за"];
  },
  97840: function _(t) {
    t.exports = ["д"];
  },
  ...
  19149: function _(t) {
    t.exports = ["Симуляция рынка недоступна для этого типа графика. Хотите выйти из режима симуляции?"];
  },
  38660: function _(t) {
    t.exports = ["Симуляция рынка недоступна для этого временного интервала. Хотите выйти из режима симуляции?"];
  },
  16812: function _(t) {
    t.exports = ["Бары"];
  },
  ...
  70213: function _(t) {
    t.exports = ["Достигнут лимит индикаторов/сигналов: {number} элементов на шаблон графиков.\nПожалуйста, удалите некоторые инструменты."];
  },
  32733: function _(t) {
    t.exports = ["Стиль"];
  },
  ...
  46669: function _(t) {
    t.exports = ["Пожалуйста, предоставьте доступ к записи в буфер обмена в вашем браузере или нажмите {keystroke}"];
  },
  35963: function _(t) {
    t.exports = ["Зажмите и держите {key} во время масштабирования, чтобы сохранить позицию графика"];
  },
  95921: function _(t) {
  ...
  8162: function _(t) {
    t.exports = ["Невозможно загрузить предпросмотр публикации. Отключите расширения браузера и попробуйте снова."];
  },
  65943: function _(t) {
