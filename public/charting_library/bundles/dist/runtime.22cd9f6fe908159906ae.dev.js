...
(function () {
  ...
  r.m = b, r.c = t, e = [], r.O = function (a, c, d, f) {
    if (!c) {
      var b = 1 / 0;

      for (i = 0; i < e.length; i++) {
        for (var _e$i = _slicedToArray(e[i], 3), c = _e$i[0], d = _e$i[1], f = _e$i[2], t = !0, o = 0; o < c.length; o++) {
          (!1 & f || b >= f) && Object.keys(r.O).every(function (e) {
            return r.O[e](c[o]);
          }) ? c.splice(o--, 1) : (t = !1, f < b && (b = f));
        }
    ...
    for (var t = 2 & d && e; "object" == _typeof(t) && !~a.indexOf(t); t = c(t)) {
    ...
    return Promise.all(Object.keys(r.f).reduce(function (a, c) {
      return r.f[c](e, a), a;
    }, []));
  }, r.u = function (e) {
    return 5652 === e ? "__LANG__.5652.afa01acb54a69426de69.js" : 2427 === e ? "__LANG__.2427.9e75295442d2edc53485.js" : 77 === e ? "__LANG__.77.99662205014782bfbe4a.js" : 6196 === e ? "__LANG__.6196.1cb6c0cf4b3c1139a67d.js" : 9871 === e ? "__LANG__.9871.80491970c40a96588ffd.js" : 7201 === e ? "__LANG__.7201.d9e269cc77c4bebf986c.js" : 3753 === e ? "__LANG__.3753.453e4c91d1197ef94e09.js" : 2521 === e ? "__LANG__.2521.8eba2dc07079697338fc.js" : 8884 === e ? "__LANG__.8884.377844211bfc698fda75.js" : 2684 === e ? "__LANG__.2684.89c78924594078c4eeb0.js" : ({
  ...
  }, d = {}, f = "tradingview:", r.l = function (e, a, c, b) {
    if (d[e]) d[e].push(a);else {
      var t, o;
      if (void 0 !== c) for (var n = document.getElementsByTagName("script"), i = 0; i < n.length; i++) {
        var s = n[i];
      ...
      t || (o = !0, (t = document.createElement("script")).charset = "utf-8", t.timeout = 120, r.nc && t.setAttribute("nonce", r.nc), t.setAttribute("data-webpack", f + c), t.src = e, 0 !== t.src.indexOf(window.location.origin + "/") && (t.crossOrigin = "anonymous")), d[e] = [a];
  ...
  }(), r.g.location && r.p.startsWith(r.g.location.origin) && (r.p = r.p.slice(r.g.location.origin.length)), function () {
    var e = r.u;

    r.u = function (a) {
      return e(a).replace("__LANG__", r.g.language);
    };
  ...
  function i(e, a) {
    return o(e)["catch"](function () {
      return new Promise(function (c) {
        var d = function d() {
          self.removeEventListener("online", d, !1), !1 === navigator.onLine ? self.addEventListener("online", d, !1) : c(a < 2 ? i(e, a + 1) : o(e));
        };
  ...
  r.e = function (e) {
    ...
    if ("undefined" != typeof document) {
        ...
        return new Promise(function (a, c) {
          ...
          if (function (e, a) {
            ...
            for (d = 0; d < b.length; d++) {
              var t;
              if ((f = (t = b[d]).getAttribute("data-href")) === e || f === a) return t;
            }
          }(d, f)) return a();

          (function (e, a, c, d, f) {
            var b = document.createElement("link");
            b.rel = "stylesheet", b.type = "text/css", b.onerror = b.onload = function (c) {
              if (b.onerror = b.onload = null, "load" === c.type) d();else {
                var t = c && ("load" === c.type ? "missing" : c.type),
                    r = c && c.target && c.target.href || a,
                    o = new Error("Loading CSS chunk " + e + " failed.\n(" + r + ")");
                o.code = "CSS_CHUNK_LOAD_FAILED", o.type = t, o.request = r, b.parentNode && b.parentNode.removeChild(b), f(o);
              }
            }, b.href = a, 0 !== b.href.indexOf(window.location.origin + "/") && (b.crossOrigin = "anonymous"), c ? c.parentNode.insertBefore(b, c.nextSibling) : document.head.appendChild(b);
          })(_e2, f, null, a, c);
        });
      },
          a = {
      ...
      r.f.miniCss = function (c, d) {
        a[c] ? d.push(a[c]) : 0 !== a[c] && {
          ...
          9842: 1,
          9916: 1
        }[c] && d.push(a[c] = e(c).then(function () {
          a[c] = 0;
        }, function (e) {
          throw delete a[c], e;
        }));
    ...
    r.f.j = function (a, c) {
      ...
      if (0 !== d) if (d) c.push(d[2]);else if (/^(1(0(13|33|54)|109|365|762|803)|2(6(39|66|76)|109|191|260|587|731)|3(8(42|43|89|96)|[06]66|502|515|610|717|939|980)|4([02]15|[39]87|894)|5(1(45|63|66)|24|403|649|866|993)|6(9(25|49|59)|[06]25|(21|49|88)4||036|106|221|639|752|831)|7(1(11|49|94)|232|350|391|413|555|871)|8(056|149|399|55|904|98)|9(32[27]|138|789|842|916))$/.test(a)) e[a] = 0;else {
        ...
        r.l(b, function (c) {
          if (r.o(e, a) && (0 !== (d = e[a]) && (e[a] = void 0), d)) {
            ...
            t.message = "Loading chunk " + a + " failed.\n(" + f + ": " + b + ")", t.name = "ChunkLoadError", t.type = f, t.request = b, d[1](t);
          }
        }, "chunk-" + a, a);
      }
    }, r.O.j = function (a) {
    ...
    r.miniCssF = function (a) {
      return self.document && "rtl" === self.document.dir ? e(a).replace(/\.css$/, ".rtl.css") : e(a);
    };
  }();
})();