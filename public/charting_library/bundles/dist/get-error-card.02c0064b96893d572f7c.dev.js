...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[139], {
  30509: function _(e) {
    e.exports = {
  ...
  81200: function _(e, t, r) {
    "use strict";

    r.r(t), r.d(t, {
      ErrorCard: function ErrorCard() {
        return p;
      },
      ErrorCardRenderer: function ErrorCardRenderer() {
        return y;
      },
      ResizableErrorCard: function ResizableErrorCard() {
        return m;
      }
    });
    var n = r(50959),
    ...
    var p = n.forwardRef(function (e, t) {
      var r = e.icon,
          o = e.message,
          _e$size = e.size,
          u = _e$size === void 0 ? 1 : _e$size,
          _e$rawHtml = e.rawHtml,
          i = _e$rawHtml === void 0 ? !1 : _e$rawHtml,
          c = e.doNotLimitWidth,
          l = e.solutionId,
      ...
      return n.createElement("div", {
        ref: t,
        className: a()(d.errorCard, 2 === u && d.errorCard_size_big, !c && d.errorCard_limitWidth)
      }, f && n.createElement(s.Icon, {
        icon: f,
    ...
    function m(e) {
      var t = e.icon,
          ...
          o = e.rawHtml,
          i = e.doNotLimitWidth,
          _e$maxWidth = e.maxWidth,
          a = _e$maxWidth === void 0 ? 200 : _e$maxWidth,
          _e$maxHeight = e.maxHeight,
          s = _e$maxHeight === void 0 ? 200 : _e$maxHeight,
          _e$offsetHeight = e.offsetHeight,
          c = _e$offsetHeight === void 0 ? 0 : _e$offsetHeight,
          l = e.solutionId,
          f = n.useRef(null),
      ...
      return n.useEffect(function () {
        ...
        if (e) {
          var _t = new ResizeObserver((0, u["default"])(m, 150));

          return _t.observe(e), function () {
            return _t.disconnect();
          };
        }
      }, [a, s, c]), n.createElement(p, {
        ref: f,
        message: r,
        icon: t,
        size: d,
      ...
      _createClass(y, [{
        ...
        value: function _updateContainer() {
          var _this$_state = this._state,
              e = _this$_state.backgroundColor,
              t = _this$_state.textColor;
          this.container.style.setProperty("--backgroundColor", e), this.container.style.setProperty("--textColor", t);
        }
      }, {
        key: "_render",
        value: function _render() {
          var _this$_state2 = this._state,
              e = _this$_state2.message,
              t = _this$_state2.icon,
              r = _this$_state2.rawHtml,
              u = _this$_state2.doNotLimitWidth,
              i = _this$_state2.maxWidth,
              a = _this$_state2.maxHeight,
              s = _this$_state2.offsetHeight,
              c = _this$_state2.solutionId;
          o.render(e ? n.createElement(m, {
            message: e,
            icon: t,
            rawHtml: r,
            doNotLimitWidth: u,
            ...
            offsetHeight: s,
            solutionId: c
          }) : n.createElement(n.Fragment, null), this.container);
        }
      }]);
  ...
  95257: function _(e, t) {
    ...
    function R(e, t, n) {
      ...
      if (1 === s) u.children = n;else if (1 < s) {
      ...
      if (e && e.defaultProps) for (o in s = e.defaultProps) {
        void 0 === u[o] && (u[o] = s[o]);
      }
      return {
        $$typeof: r,
    ...
    function $(e, t, o, u, i) {
      ...
      if (s) return i = i(s = e), e = "" === u ? "." + H(s, 0) : u, b(i) ? (o = "", null != e && (o = e.replace(x, "$&/") + "/"), $(i, t, o, "", function (e) {
        return e;
      ...
      }(i, o + (!i.key || s && s.key === i.key ? "" : ("" + i.key).replace(x, "$&/") + "/") + e)), t.push(i)), 1;
      if (s = 0, u = "" === u ? "." : u + ":", b(e)) for (var c = 0; c < e.length; c++) {
        var l = u + H(a = e[c], c);
        s += $(a, t, o, l, i);
    ...
    t.Children = {
    ...
    }, t.Component = v, t.Fragment = o, t.Profiler = i, t.PureComponent = g, t.StrictMode = u, t.Suspense = l, t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = A, t.cloneElement = function (e, t, n) {
      ...
      if (null != t) {
        if (void 0 !== t.ref && (i = t.ref, a = S.current), void 0 !== t.key && (u = "" + t.key), e.type && e.type.defaultProps) var s = e.type.defaultProps;

        for (c in t) {
          w.call(t, c) && !E.hasOwnProperty(c) && (o[c] = void 0 === t[c] && void 0 !== s ? s[c] : t[c]);
        }
      }
