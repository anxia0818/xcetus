...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[7648], {
  57351: function _(e, a, t) {
    "use strict";

    t.r(a), t.d(a, {
      showThemeSaveDialog: function showThemeSaveDialog() {
        return i;
      }
    });
    var m = t(44352),
    ...
    function i(e, a, i, l) {
      function h(t) {
        (0, s.saveTheme)(t, e).then(function () {
          a && a(t);
      ...
      (0, o.showRename)({
        ...
        onRename: function onRename(_ref) {
          var e = _ref.newValue,
              a = _ref.focusInput,
              r = _ref.dialogClose,
              n = _ref.innerManager;
          return new Promise(function (i) {
            (0, s.isThemeExist)(e).then(function (s) {
              if (s) {
                var _s = m.t(null, {
                  replace: {
                    themeName: e
  ...
  89028: function _(e) {
    e.exports = {
      ...
      es: ["La paleta de colores '{themeName}' ya existe. ¿Está seguro de que desea sustituirla?"],
      ...
      pl: ["Motyw kolorystyczny o nazwie '{themeName}' już istnieje. Czy naprawdę chcesz go zastąpić?"],
